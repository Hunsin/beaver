...
var (
	...
	// DefaultTag is a LTag with default strings
	DefaultTag = LTag{"FATAL:", "ERROR:", "WARN :", "INFO :", "DEBUG:"}

	// BracketTag is a LTag with "[...]" style
	BracketTag = LTag{"[FATAL]", "[ERROR]", "[WARN ]", "[INFO ]", "[DEBUG]"}
)
...
// New returns a new Logger. By default, it logs at all
